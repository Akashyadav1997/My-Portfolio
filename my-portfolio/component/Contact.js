...
const Contact = () => {
	...
	const handleSubmit = async (e) => {
		try {
			...
			if (success) {
				toast.success(
					`Thank You ${newName} We will reach out to you shortly`
				);
			} else {
				toast.error(message);
			}
	...
	return (
		<>
			...
			<div className="grid xl:grid-flow-col  xl:grid-cols-2 w-full mt-8">
				...
				>
					<Form className="shadow-2xl dark:shadow-white dark:bg-[#595757] w-4/5 flex flex-col items-center xl:items-end justify-self-center xl:justify-self-end rounded-xl">
						...
						<div className="flex flex-col items-start w-4/5 my-2">
							<button
								type="submit"
								className="p-3 my-4 w-2/5 bg-blue-500 text-white rounded hover:bg-blue-700 duration-300"
							>
